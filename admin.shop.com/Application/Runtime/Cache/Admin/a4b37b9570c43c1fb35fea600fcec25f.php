...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main-div">
            <div id="menu-list">
                <ul id="menu-ul">
                    <?php if(is_array($menus)): foreach($menus as $key=>$top_menu): if(($top_menu["parent_id"]) == "0"): ?><li class="explode" key="02_cat_and_goods" name="menu">
                    ...
                    <li class="explode" key="08_members" name="menu">
                        设置
                        <ul>
                            <li class="menu-item"><a href="<?php echo U('Admin/alter');?>" target="main-frame">修改密码</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
